...
module.exports = new EntitySchema({
  ...
  columns: {
    ...
    title_jp: { type: 'varchar', length: 255, nullable: false, comment: '콘텐츠 타이틀 이름 JP' },
    description: { type: 'varchar', length: 255, nullable: false },
    description_eng: { type: 'varchar', length: 255, nullable: false },
    description_jp: { type: 'varchar', length: 255, nullable: false },
    ...
    short_description_jp: { type: 'varchar', length: 255, nullable: false },
